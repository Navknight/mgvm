...
// HybridGPUPlatformBuilder can build a platform that equips DisTLBGPU GPU.
type HybridGPUPlatformBuilder struct {
...
func MakeHybridGPUPlatformBuilder() HybridGPUPlatformBuilder {
	b := HybridGPUPlatformBuilder{
		CommonPlatformBuilder{
			numGPU:                   1,
...
func (b HybridGPUPlatformBuilder) WithL2TLBStriping(striping uint64) HybridGPUPlatformBuilder {
	b.l2TlbStriping = striping
	return b
}

// Build builds a platform with DisTLBGPU GPUs.
func (b HybridGPUPlatformBuilder) SwitchL2TLBStriping(switchStriping bool) HybridGPUPlatformBuilder {
	b.switchL2TLBStriping = switchStriping
	return b
}

// Build builds a platform with DisTLBGPU GPUs.
func (b HybridGPUPlatformBuilder) UsePtCaching(ptCaching bool) HybridGPUPlatformBuilder {
	b.usePtCaching = ptCaching
	return b
}

// Build builds a platform with DisTLBGPU GPUs.
func (b HybridGPUPlatformBuilder) Build() (akita.Engine, *driver.Driver) {
...
func (b *HybridGPUPlatformBuilder) createGPUBuilder(
	engine akita.Engine,
